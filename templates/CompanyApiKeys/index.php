 ...
 * @var iterable<\App\Model\Entity\CompanyMst> $companyKyes
 */
?>
...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<?= $this->Form->create($companyKyes,['horizontal' => true]) ?>
			<div class="card-body">
...
$(document).ready(function () {
	...
	$('#dataTables-example').DataTable({
		...
		"ajax": {
			url : '<?= $this->Url->build(["controller" => "CompanyApiKeys","action" => "ajaxListIndex"]) ?>',
			data: formdata,
			type: 'POST',
