					...
					<div class="row gy-4">
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="row gy-4">
								<div class="col-xxl-12 col-md-12">
									<div class="input-container-floating ">
										<label for="basiInput" class="form-label panel-heading">Coversheets by Rec Date:</label>
										<div class="row">
					...
					<div class="row gy-4">
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="row gy-4">
								<div class="col-xxl-12 col-md-12">
									<div class="input-container-floating ">
										<label for="basiInput" ><b>E-record capable:</b></label>
										<?php echo $this->Form->radio('eCapable',
													[
														['value' => 'Y', 'text'=>__('E-record Capable')],
														['value' => 'N', 'text' => __('Not E-Record capable')],
														['value' => '', 'text' => __('Both')],
													],
													['required'=>false, 
													'value' => isset($eCapable) ? $eCapable : '',
													'default' => 'N', 'class'=>'i-checks'
													]); ?>
									</div>
								</div>
							</div>
