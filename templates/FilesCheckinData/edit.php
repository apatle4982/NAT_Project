					...
					<div class="row gy-4">
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								['label'=>false ,
								'type'=>'text','class'=>'form-control', 'required'=>true, 'value'=>(isset($filesCheckinData['FileStartDate']) ? date('Y-m-d H:i:s', strtotime($filesCheckinData['FileStartDate'])) : '')]); ?>
								</div>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<?php echo $this->Form->control('TransactionType', ['label'=>false,'type'=>'text', 'value'=> $filesCheckinData['fcd']['TransactionType'], 'class'=>'form-control', 'required'=>false, 'placeholder'=>'Number only (seperated by " , ")']); ?>
								
								<?php echo $this->Form->control('documentTypeHidden', [ 'value'=>($filesCheckinData['TransactionType']==0) ? $filesCheckinData['fcd']['TransactionType'] : $filesCheckinData['fcd']['TransactionType'] , 'type'=>'hidden']); ?>
							</div>		 
						</div>
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
