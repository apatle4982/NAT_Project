...
<body>
    ...
    <?= $this->Html->script(["/assets/libs/bootstrap/js/bootstrap.bundle.min","/assets/libs/simplebar/simplebar.min","/assets/libs/node-waves/waves.min","/assets/libs/feather-icons/feather.min","/assets/js/pages/plugins/lord-icon-2.1.0","/assets/js/plugins","/assets/libs/apexcharts/apexcharts.min","/assets/libs/jsvectormap/js/jsvectormap.min","/assets/libs/jsvectormap/maps/world-merc","/assets/js/pages/dashboard-analytics.init"]) ?>
    ...
    <?= $this->Html->script(["/assets/js/pages/datatables.init","/assets/js/app"]) ?>
