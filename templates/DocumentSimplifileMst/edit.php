 ...
 */
?>
<?= $this->Form->create($documentSimplifileMst) ?>
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			<div class="card-body">
					...
					<div class="row gy-4">
						<div class="col-xxl-6 col-md-6 col-sm-12">
							<div class="row gy-4">
								...
								<div class="col-xxl-12 col-md-12">
                                    <div class="input-container-floating">
                                    <label for="basiInput" class="form-label">Simplifile Document Type Name<span style="color:#CA3F48">*</span></label>
...
<script>
	...
	function  getCounty(StateId, divId){ 
		$.ajax({
		  method: "POST",
		  url : '<?= $this->Url->build(["controller" => 'DocumentSimplifileMst',"action" => "searchCountyAjax"]) ?>',
		  data: { id: StateId}
