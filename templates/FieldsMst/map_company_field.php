                ...
                <div class="live-preview">
                    <div class="row gy-4">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3">
                            <div class="txtbox-btn">
                                <div class="submit">
                                    <?php //= $this->Form->submit(__('Add Default Export Sheet Fields'),['name'=>'defaultExportBtn','class'=>'btn btn-success']); ?>        
                                </div>                             
                            </div>
                        </div>  
                         

                        <div class="col-xs-12 col-sm-4 col-md-5 btm-inline">
                            <div class="submit">
