                    ...
                    <div class="row dash-section">
                        <div class="col-xxl-3 col-md-3 col-sm-12 ico-section">
                            <div class="dash-container">
                                ...
                                <h2><?php echo $this->Html->link(__('Master Search'), ['controller' => 'master-data', 'action'=>'master-search']); ?></h2>
                            </div>
                        </div>
                        <div class="col-xxl-3 col-md-3 col-sm-12 ico-section">
                            <div class="dash-container">
                        ...
                        <div class="col-xxl-3 col-md-3 col-sm-12 ico-section">
                            <div class="dash-container">
                                ...
                                <h2><?= $this->Html->link('Records', ['controller' => 'FilesCheckinData', 'action' => 'index']) ?></h2>
                            </div>
                        </div>
                        <!--<div class="col-xxl-3 col-md-3 col-sm-12 ico-section">
                            <div class="dash-container">
