                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"> 
                                    <div class="row input-daterange m-b" id="datepicker">
                                        ...
                                        Shipping Processing Date:
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4"> 
                                            <div class="input-container-floating">
                                                <label for="basiInput" class="form-label"><?= __('From Date') ?></label> 
                                                <?= $this->Form->control('ShipStartDate', ['placeholder' => '(yyyy-mm-dd)', 'label' => false, 'class'=>'input-sm form-control', 'value' => ($ShipStartDate ? $ShipStartDate : date("Y-m-d"))]) ?>
                                            </div>
                                        </div>
                                        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                            <div class="input-container-floating">
                                                <label for="basiInput" class="form-label"><?= __('To Date') ?></label>
                                                <?= $this->Form->control('ShipEndDate', ['placeholder' => '(yyyy-mm-dd)', 'label' =>false, 'class'=>'input-sm form-control', 'value' => ($ShipEndDate ? $ShipEndDate : date("Y-m-d"))]) ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
