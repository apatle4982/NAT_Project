							...
							<div class="col-xxl-4 col-md-4 col-sm-12 bord-rght">
								...
								<div class="row">
									<div class="col-xxl-12 col-md-12">
										...
										<?php if(!($user_Gateway)){ 
												echo $this->Html->link(__('<span style="color:red"> <i>( Edit )</i></span>'), ['controller' => 'FilesCheckinData', 'action' => 'edit',$fileCKData['Id'],"complete"],['title'=>'Edit Partner Details', 'escape'=>false]);
											} ?>
								...
								<div class="row">
									...
									<h2><?= __("Check In Data") ?>
										...
										<div class="input-container-floating output-container">
											<label for="basiInput" class="form-label"><?php echo (isset($partnerMapFields['mappedtitle']['TransactionType'])) ? ($partnerMapFields['mappedtitle']['TransactionType'] == 'TransactionType') ? 'Document Type' : $partnerMapFields['mappedtitle']['TransactionType'] : 'Document Type'; ?>  :</label>
											<div class="input-value"><?= $filesMainData['DocumentTypeMst']['Title']?></div> 
										</div>
										<div class="input-container-floating output-container">
									...
									<div class="col-xxl-12 col-md-12">
										...
										<div class="row">
											<div class="col-xxl-4 col-md-4 col-sm-12">
												...
												<!--<div class="input-container-floating output-container">
													<label for="basiInput" class="form-label">Recording Note :</label>
