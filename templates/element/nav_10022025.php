                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarRecords">
                        <ul class="nav nav-sm flex-column"> 
                            ...
                            <li class="nav-item">
								<?= $this->Html->link('Add Vendor User', ['controller' => 'vendor', 'action' => 'add'], ['class' => 'nav-link','data-key'=>'t-index']) ?>
                            </li>
							<li class="nav-item">
								<?= $this->Html->link('Vendor Users', ['controller' => 'vusers', 'action' => 'index'], ['class' => 'nav-link','data-key'=>'t-add']) ?>
                            </li>
