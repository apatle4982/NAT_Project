		...
		<table class="table dataTable order-column stripe table-striped table-bordered" id="datatable_example">
			<thead>
				<tr>
					...
					<?php if($this->request->getParam('controller') == "FilesExamReceiptNOTREQUIRED") { ?>
					...
					<?php } ?>
					<!--<th ><?= __('ECapable') ?></th>-->
					<?php if($this->request->getParam('controller') == "FilesVendorAssignment" || $this->request->getParam('controller') == "FilesExamReceipt") { ?>
