            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPartners">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <?php endif; ?>
                            <li class="nav-item">
                                <?= $this->Html->link('Manage Partner API Key', ['controller' => 'company-api-keys', 'action' => 'index'], ['class' => 'nav-link','data-key'=>'t-partnerapikey']) ?>
                            </li> 
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarRecords" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRecords">
                        <i class="las la-record-vinyl"></i> <span data-key="t-records">Records</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarRecords">
                        <ul class="nav nav-sm flex-column"> 
                            ...
                            <!-- <li class="nav-item">
								<?= $this->Html->link('Attorney Assignment', ['controller' => 'FilesVendorAssignment', 'action' => 'attindex'], ['class' => 'nav-link','data-key'=>'t-index']) ?>
                            </li> -->
                            <li class="nav-item">
								<?= $this->Html->link('Escrow Service Assignment', ['controller' => 'FilesVendorAssignment', 'action' => 'essindex'], ['class' => 'nav-link','data-key'=>'t-index']) ?>
                            </li>
							<!--<li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarRecords" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRecords">
                        <i class="ri-settings-2-line"></i> <span data-key="t-records">Vendor Management</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarRecords">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                ...
                <!-- <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarRecords" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRecords">
                        <i class="ri-account-circle-line"></i> <span data-key="t-records">Masters</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarRecords">
                        <ul class="nav nav-sm flex-column"> 
                            <li class="nav-item">
								<?= $this->Html->link('Search Record', ['controller' => 'MasterData', 'action' => 'masterSearch'], ['class' => 'nav-link','data-key'=>'t-uploadcsv']) ?>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarRecords" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRecords">
                        <i class="ri-settings-2-line"></i> <span data-key="t-records">Receipt of Exam<!-- AOL Processing --></span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarRecords">
                        <ul class="nav nav-sm flex-column"> 
                            <li class="nav-item">
                            ...
                            <?php if ($authUser && $authUser->isSuperAdmin_Or_isLimited()): ?>
                                <li class="nav-item">
                                    <?= $this->Html->link('Upload Receipt of Exam CSV', ['controller' => 'FilesExamReceipt', 'action' => 'upload'], ['class' => 'nav-link','data-key'=>'t-receipt']) ?>
                                </li>
                            <?php endif; ?>   
                            <?php if ($authUser && $authUser->isSuperAdmin_Or_isLimited()): ?> 
                                <li class="nav-item">
                                    <?= $this->Html->link('Map Receipt of Exam Fields', ['controller' => 'FieldsMstExam', 'action' => 'map-company-field'], ['class' => 'nav-link','data-key'=>'t-receipt']) ?>
                                </li>
                            <?php endif; ?>    
                            <?php if ($authUser && $authUser->isSuperAdmin_Or_isLimited()): ?>
                                <li class="nav-item">
                                    <?= $this->Html->link('Import Receipt of Exam Fields', ['controller' => 'FieldsMstExam', 'action' => 'import-company-field'], ['class' => 'nav-link','data-key'=>'t-receipt']) ?>
                                </li>
                            <?php endif; ?>    
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarRecords" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRecords">
                        <i class="las la-file-upload"></i> <span data-key="t-records">Recording Data</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarRecords">
                        <ul class="nav nav-sm flex-column"> 
                            <li class="nav-item">
                                <?= $this->Html->link('Recording Data', ['controller' => 'FilesRecordingData', 'action' => 'index'], ['class' => 'nav-link','data-key'=>'t-receipt']) ?>
                            </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarShip" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarShip">
                        <i class="ri-account-circle-line"></i> <span data-key="t-ship">County Cal</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarShip">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">								
								<?= $this->Html->link('County Cal', ['controller' => 'FilesAccountingData', 'action' => 'index'], ['class' => 'nav-link','data-key'=>'t-accountingentry']) ?>
                            </li>                            
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarCal" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarCal">
                        <i class="ri-settings-2-line"></i> <span data-key="t-reports">Reports</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarCal">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">								
								<?php if ($user_group_id == ADMIN_GROUP) { // ADMIN_GROUP = 1 ?>
									<li class="nav-item">
										<?= $this->Html->link('Generate Report', ['controller' => 'FieldsMst', 'action' => 'exportCompanyField'], ['class' => 'nav-link','data-key'=>'t-exportsheetsetting']) ?>
									</li> 
								<?php } ?>
                            </li>                            
                        </ul>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarOthers">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <?= $this->Html->link('Upload Supporting Document', ['controller' => 'FilesExamReceipt', 'action' => 'uploadSupportingDocument'], ['class' => 'nav-link','data-key'=>'t-userlisting']) ?>
                            </li> 
                            <li class="nav-item">
                                <?= $this->Html->link('Transaction Type Master', ['controller' => 'TransactionTypeMst', 'action' => 'index'], ['class' => 'nav-link','data-key'=>'t-userlisting']) ?>
                            </li>
                        </ul>
                    </div>
                </li> 
