				...
				<div class="table-responsive">
					...
					<tbody>
						...
						<tr class="even">
							...
							<td style="padding:4px"  align="left"><?= __('loan_amount') ?></td>
							<td style="padding:4px"  align="left"><?= __('20000') ?></td>
						</tr>
						<tr class="odd">
							<td style="padding:4px" ><?= __('C.') ?></td>
							<td style="padding:4px"  align="left"><?= __('file_start_date') ?></td>
