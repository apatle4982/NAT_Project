...
<div class="card" style="margin-top:15px">
	...
	<div class="row">
		<div class="col-xxl-12 col-md-12 col-sm-12">
			...
			<div class="vesting-field-group-<?php echo $index;?> vesting-groups live-preview">
				<!-- <div class="row">
					<div class="col-xxl-12 col-md-12 col-sm-12" style="margin-bottom:10px !important">
								...
								<div class="row gy-4">
									<div class="col-xxl-12 col-md-12" style="margin: 0px !important;">
										<div class="input-container-floating">
											...
											['label'=>false, 'class'=>'form-control', 'required'=>false, 'value'=>(isset($vesting_attribute['VestingDated']) ? date('Y-m-d H:i:s', strtotime($vesting_attribute['VestingDated'])) : ''),  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row gy-4">
									<div class="col-xxl-12 col-md-12" style="margin: 0px !important;">
										<div class="input-container-floating">
											...
											['label'=>false, 'class'=>'form-control', 'required'=>false, 'value'=>(isset($vesting_attribute['VestingRecordedDate']) ? date('Y-m-d H:i:s', strtotime($vesting_attribute['VestingRecordedDate'])) : ''),  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
										</div>
									</div>
								</div>
							</div>
	...
	<div class="row">
		<div class="col-xxl-12 col-md-12 col-sm-12">
			...
			<div class="open-mortgage-field-group-<?php echo $index;?> open-mortgage-groups live-preview">
				<!-- <div class="row">
					<div class="col-xxl-12 col-md-12 col-sm-12" style="margin-bottom:10px !important">
						<div class="card-header align-items-center d-flex" style="border: none !important;">
								...
								<div class="row gy-4">
									<div class="col-xxl-12 col-md-12" style="margin: 0px !important;">
										<div class="input-container-floating">
											...
											['label'=>false, 'class'=>'form-control', 'required'=>false, 'value'=>(isset($open_mortgage_attribute['OpenMortgageDated']) ? date('Y-m-d H:i:s', strtotime($open_mortgage_attribute['OpenMortgageDated'])) : ''),  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row gy-4">
									<div class="col-xxl-12 col-md-12" style="margin: 0px !important;">
										<div class="input-container-floating">
											...
											['label'=>false, 'class'=>'form-control', 'required'=>false, 'value'=>(isset($open_mortgage_attribute['OpenMortgageRecordedDate']) ? date('Y-m-d H:i:s', strtotime($open_mortgage_attribute['OpenMortgageRecordedDate'])) : ''),  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
										</div>
									</div>
								</div>
							</div>
	...
	<div class="row">
		<div class="col-xxl-12 col-md-12 col-sm-12">
			...
			<div class="open-judgments-field-group-<?php echo $index;?> open-judgments-groups live-preview">
				<!-- <div class="row">
					<div class="col-xxl-12 col-md-12 col-sm-12" style="margin-bottom:10px !important">
						<div class="card-header align-items-center d-flex" style="border: none !important;">
								...
								<div class="row gy-4">
									<div class="col-xxl-12 col-md-12" style="margin: 0px !important;">
										<div class="input-container-floating">
											...
											['label'=>false, 'class'=>'form-control', 'required'=>false, 'value'=>(isset($open_judgments_attribute['OpenJudgmentsDateEntered']) ? date('Y-m-d H:i:s', strtotime($open_judgments_attribute['OpenJudgmentsDateEntered'])) : ''),  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="row gy-4">
									<div class="col-xxl-12 col-md-12" style="margin: 0px !important;">
										<div class="input-container-floating">
											...
											['label'=>false, 'class'=>'form-control', 'required'=>false, 'value'=>(isset($open_judgments_attribute['OpenJudgmentsDateRecorded']) ? date('Y-m-d H:i:s', strtotime($open_judgments_attribute['OpenJudgmentsDateRecorded'])) : ''),  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
										</div>
									</div>
								</div>
							</div>
