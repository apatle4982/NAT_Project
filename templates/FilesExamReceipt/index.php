                ...
                <div class="live-preview ">
                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-md-12 col-sm-12">
                            <strong style="color:red">Important Note:</strong> <strong>This list displays only records that have been assigned to a vendor. If you do not see a specific record, please ensure that a vendor has been assigned to it before proceeding.</strong>
                        </div>
                    </div>
                    <h2 style="display:none">Vendor Assigned Status</h2> 
