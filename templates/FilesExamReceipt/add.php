			...
			<div class="card-body">
				<div class="live-preview ">
					<div class="row gy-4">
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">	
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['street_number'])) ? $partnerMapFields['mappedtitle']['street_number'] : 'Street Number');?></label>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['street_name'])) ? $partnerMapFields['mappedtitle']['street_name'] : 'Street Name') ?></label>
					...
					<div class="row gy-4">
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['marital_status_g1'])) ? $partnerMapFields['mappedtitle']['marital_status_g1'] : 'Marital Status'); ?></label>
								
								<?php echo $this->Form->control('marital_status_g1', ['label'=>false,
								'class'=>'form-control', 'required'=>false,  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
							</div> 
						</div>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['corporation_name_g1'])) ? $partnerMapFields['mappedtitle']['corporation_name_g1'] : 'Corporation Name'); ?></label>
								
								<?php echo $this->Form->control('corporation_name_g1', ['label'=>false,
								'class'=>'form-control', 'required'=>false,  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
							</div> 
						</div>
					...
					<div class="row gy-4">
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">										
								...
								['label'=>false,
								'class'=>'form-control', 'value'=>$nat_file_number, 'required'=>true,  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
							</div>		 
						</div>
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<?php echo $this->Form->control('transaction_type', ['label'=>false,'type'=>'text', 'class'=>'form-control', 'required'=>false, 'pattern'=>'[0-9 ,]+', 'placeholder'=>'Number only (seperated by " , ")']); ?>
							</div>		 
						</div>
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
