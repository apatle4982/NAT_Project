    ...
    <div class="row">
        ...
        <div>&nbsp;</div>
            ...
            <div class="question">
                ...
                <?= $this->Form->radio('q1', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'explain1')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'explain1')"]],['value' => $attorneyReviewDtl['q1']]) ?> - <i>If NO, explain:</i>
                <?= $this->Form->textarea('explain1', ['id' => 'explain1', 'style' => 'display:none;', 'placeholder' => 'Please explain...','value' => $attorneyReviewDtl['explain1']]) ?>
              </div>
              ...
              <div class="question">
                ...
                <?= $this->Form->radio('q2', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'explain2')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'explain2')"]],['value' => $attorneyReviewDtl['q2']]) ?> - <i>If NO, explain:</i>
                <?= $this->Form->textarea('explain2', ['id' => 'explain2', 'style' => 'display:none;', 'placeholder' => 'Please explain...','value' => $attorneyReviewDtl['explain2']]) ?>
              </div>

              <div class="question">
                <label><b>3. Borrower(s) as Individuals</b></label>
                <div class="sub-question">Are all Borrower(s) individuals?</div>
                <!--<?= $this->Form->radio('q3', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'sub3')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'sub3')"]],['value' => $attorneyReviewDtl['q3']]) ?>-->
                <?= $this->Form->radio('q3', [
                  ['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'sub3', false)"],
                  ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'sub3', true)"]
                ],['value' => $attorneyReviewDtl['q3']]) ?> - <i>If NO, complete the following sub-questions:</i>
                <div id="sub3" style="display:none">
                  <div class="sub-question">
                    ...
                    <?= $this->Form->radio('q3a', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'explain3a')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'explain3a')"]],['value' => $attorneyReviewDtl['q3a']]) ?> - <i>If NO, explain:</i>
                    <?= $this->Form->textarea('explain3a', ['id' => 'explain3a', 'style' => 'display:none;', 'placeholder' => 'Please explain...','value' => $attorneyReviewDtl['explain3a']]) ?>
                  </div>
                  <div class="sub-question">
                    ...
                    <?= $this->Form->radio('q3b', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'explain3b')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'explain3b')"]],['value' => $attorneyReviewDtl['q3b']]) ?> - <i>If NO, explain:</i>
                    <?= $this->Form->textarea('explain3b', ['id' => 'explain3b', 'style' => 'display:none;', 'placeholder' => 'Please explain...','value' => $attorneyReviewDtl['explain3b']]) ?>
                  </div>
                </div>
              </div>
              ...
              <div class="question">
                ...
                <?= $this->Form->radio('q4', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'explain4')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'explain4')"]],['value' => $attorneyReviewDtl['q4']]) ?> - <i>If NO, explain:</i>
                <?= $this->Form->textarea('explain4', ['id' => 'explain4', 'style' => 'display:none;', 'placeholder' => 'Please explain...','value' => $attorneyReviewDtl['explain4']]) ?>
              </div>
              ...
              <div class="question">
                ...
                <?= $this->Form->radio('q5', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'sub5')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'sub5')"]],['value' => $attorneyReviewDtl['q5']]) ?> - <i>If NO, skip to Question 6.</i>
                <div id="sub5" style="display:none">
                  <div class="sub-question">
                    ...
                    <?= $this->Form->radio('q5a', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'explain5a')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'explain5a')"]],['value' => $attorneyReviewDtl['q5a']]) ?> - <i>If NO, explain:</i>
                    <?= $this->Form->textarea('explain5a', ['id' => 'explain5a', 'style' => 'display:none;', 'placeholder' => 'Please explain...','value' => $attorneyReviewDtl['explain5a']]) ?>
                  </div>
                </div>
              </div>
              ...
              <div class="question">
                ...
                <?= $this->Form->radio('q6', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'explain6')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'explain6')"]],['value' => $attorneyReviewDtl['q6']]) ?> - <i>If NO, explain:</i>
                <?= $this->Form->textarea('explain6', ['id' => 'explain6', 'style' => 'display:none;', 'placeholder' => 'Please explain...','value' => $attorneyReviewDtl['explain6']]) ?>
              </div>
              ...
              <div class="question">
                ...
                <?= $this->Form->radio('q7', [['value' => 'Yes', 'text' => 'Yes', 'onchange' => "toggleExplain(this, 'explain7')"], ['value' => 'No', 'text' => 'No', 'onchange' => "toggleExplain(this, 'explain7')"]],['value' => $attorneyReviewDtl['q7']]) ?> - <i>If NO, explain:</i>
                <?= $this->Form->textarea('explain7', ['id' => 'explain7', 'style' => 'display:none;', 'placeholder' => 'Please explain...','value' => $attorneyReviewDtl['explain7']]) ?>
              </div>
            <!-- ******************************************** Question End ****************************************** -->
            <div class="mb-3">
            ...
            <div id="deny_comment" class="mb-3">
                ...
                <?= $this->Form->textarea('comment', ['value'=>$attorneyReviewDtl['comment'],'class' => 'form-control']) ?>
            </div>

            <div class="attorney-signature mb-3" style="height:95px;">
                <label class="d-block">Signature of Reviewing Attorney & Finish The Process</label>
                ...
                <div id="deny_comment" class="mb-3">
                    ...
                    <?= $this->Form->button(__('Add Signature in AOL PDF & Finish The Process'), ['id'=>'save-signature','class' => 'btn btn-primary']) ?>
                </div>
            </div>
            <?= $this->Form->end() ?>
        </div>
        ...
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <?php
                    if (!empty($examReceiptFields1['supporting_documentation']))
                    {

                        $filePath_1 = WWW_ROOT . 'uploads' . DS . $examReceiptFields1['supporting_documentation'];
                        $filePath_2 = WWW_ROOT . 'supporting_documents' . DS . $examReceiptFields1['supporting_documentation'];
                        
                        if (file_exists($filePath_2) ) {

                            $buldUrl = $this->Url->build('/supporting_documents/' . $examReceiptFields1['supporting_documentation'], ['fullBase' => true]);
                        }	
                        else if (file_exists($filePath_1) ) {	
                            $buldUrl = $this->Url->build('/uploads/' . $examReceiptFields1['supporting_documentation'], ['fullBase' => true]);
                        }	
                        	
                ?> 
                        <a download class="btn btn-secondary docs" href="<?= $buldUrl ?>" target="_blank">Supporting Documents
            ...
            <!-- <div style="position: relative; height: 100vh;">
                <iframe src="https://your-docusign-embedded-url" style="width:100%; height:100%; border:none;" id="docusignIframe"></iframe> -->
                
                <!-- Overlay to block top-right corner -->
                <!-- <div style="position:absolute; top:0; right:0; width:100px; height:60px; background:white; z-index:999;"></div>
            </div> -->
                    ...
                    <div class="live-preview">
                        <div class="row gy-4">
                            <div class="col-xxl-12 col-md-12">
                                <label class="mb-0">Partner: <?= h($companyMsts['cm_comp_name'] ?? 'N/A'); ?></label>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        var yesRadio_q1 = document.querySelector('input[name="q1"][value="Yes"]');
        var noRadio_q1 = document.querySelector('input[name="q1"][value="No"]');

        var yesRadio_q2 = document.querySelector('input[name="q2"][value="Yes"]');
        var noRadio_q2 = document.querySelector('input[name="q2"][value="No"]');

        var yesRadio_q3 = document.querySelector('input[name="q3"][value="Yes"]');
        var noRadio_q3 = document.querySelector('input[name="q3"][value="No"]');

        var yesRadio_q3a = document.querySelector('input[name="q3a"][value="Yes"]');
        var noRadio_q3a = document.querySelector('input[name="q3a"][value="No"]');

        var yesRadio_q3b = document.querySelector('input[name="q3b"][value="Yes"]');
        var noRadio_q3b = document.querySelector('input[name="q3b"][value="No"]');

        var yesRadio_q4 = document.querySelector('input[name="q4"][value="Yes"]');
        var noRadio_q4 = document.querySelector('input[name="q4"][value="No"]');

        var yesRadio_q5 = document.querySelector('input[name="q5"][value="Yes"]');
        var noRadio_q5 = document.querySelector('input[name="q5"][value="No"]');

        var yesRadio_q5a = document.querySelector('input[name="q5a"][value="Yes"]');
        var noRadio_q5a = document.querySelector('input[name="q5a"][value="No"]');

        var yesRadio_q6 = document.querySelector('input[name="q6"][value="Yes"]');
        var noRadio_q6 = document.querySelector('input[name="q6"][value="No"]');

        var yesRadio_q7 = document.querySelector('input[name="q7"][value="Yes"]');
        var noRadio_q7 = document.querySelector('input[name="q7"][value="No"]');
        
        if (yesRadio_q1 && yesRadio_q1.checked) {
            toggleExplain(yesRadio_q1, 'explain1');
            document.querySelector("#explain1").value = '';
        } else if (noRadio_q1 && noRadio_q1.checked) {
            toggleExplain(noRadio_q1, 'explain1');
        }

        if (yesRadio_q2 && yesRadio_q2.checked) {
            toggleExplain(yesRadio_q2, 'explain2');
            document.querySelector("#explain2").value = '';
        } else if (noRadio_q2 && noRadio_q2.checked) {
            toggleExplain(noRadio_q2, 'explain2');
        }

        if (yesRadio_q3 && yesRadio_q3.checked) {
            toggleExplain(yesRadio_q3, 'sub3',false);
           
            document.querySelector("#explain3a").value = '';
            document.querySelector("#explain3b").value = '';
        } else if (noRadio_q3 && noRadio_q3.checked) { 
            toggleExplain(noRadio_q3, 'sub3',true);
        }

        if (yesRadio_q3a && yesRadio_q3a.checked) {
            toggleExplain(yesRadio_q3a, 'explain3a');
            document.querySelector("#explain3a").value = '';
        } else if (noRadio_q3a && noRadio_q3a.checked) {
            toggleExplain(noRadio_q3a, 'explain3a');
        }

        if (yesRadio_q3b && yesRadio_q3b.checked) {
            toggleExplain(yesRadio_q3b, 'explain3b');
            document.querySelector("#explain3b").value = '';
        } else if (noRadio_q3b && noRadio_q3b.checked) {
            toggleExplain(noRadio_q3b, 'explain3b');
        }

        if (yesRadio_q4 && yesRadio_q4.checked) {
            toggleExplain(yesRadio_q4, 'explain4');
            document.querySelector("#explain4").value = '';
        } else if (noRadio_q4 && noRadio_q4.checked) {
            toggleExplain(noRadio_q4, 'explain4');
        }

        if (yesRadio_q5 && yesRadio_q5.checked) {
            toggleExplain(yesRadio_q5, 'sub5');
            document.querySelector("#explain5a").value = '';
        } else if (noRadio_q5 && noRadio_q5.checked) {
            toggleExplain(noRadio_q5, 'sub5');
        }

        if (yesRadio_q5a && yesRadio_q5a.checked) {
            toggleExplain(yesRadio_q5a, 'explain5a');
            document.querySelector("#explain5a").value = '';
        } else if (noRadio_q5a && noRadio_q5a.checked) {
            toggleExplain(noRadio_q5a, 'explain5a');
        }

        if (yesRadio_q6 && yesRadio_q6.checked) {
            toggleExplain(yesRadio_q6, 'explain6');
            document.querySelector("#explain6").value = '';
        } else if (noRadio_q6 && noRadio_q6.checked) {
            toggleExplain(noRadio_q6, 'explain6');
        }

        if (yesRadio_q7 && yesRadio_q7.checked) {
            toggleExplain(yesRadio_q7, 'explain7');
            document.querySelector("#explain7").value = '';
        } else if (noRadio_q7 && noRadio_q7.checked) {
            toggleExplain(noRadio_q7, 'explain7');
        }
    });
</script>
<script>
...
$(document).ready(function () {
    ...
    $("#save-signature").click(function (e) {
        ...
        //console.log(signatureData[1].length);return;
        e.preventDefault(); */
    ...
    $('input[type=radio][name=status]').change(function() {
        ...
        if (unanswered.length > 0) {
            alert("Please answer all required questions before selecting status.\nMissing: " + unanswered.join(", "));
            $(this).prop("checked", false); // uncheck Accept/Deny
        }
