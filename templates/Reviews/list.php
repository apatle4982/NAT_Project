...
<style type="text/css">
<!--
.search-partner .input-container-floating .form-control { width: 60% !important;height: auto !important;}
-->
</style>
...
<div class="row">
	<div class="col-lg-12">
		<div class="card">
			...
			<?= $this->Form->create($AttorneyReviews,['horizontal' => true]) ?>
			<div class="card-body">
							...
							<div class="row gy-4">
								<div class="col-xxl-12 col-md-12">
									<div class="input-container-floating ">
										<label for="basiInput" class="form-label">NAT File Number</label>
										<?= $this->Form->control('RecId', ['value'=>isset($formpostdata['RecId'])? $formpostdata['RecId']: '' , 'label' => false, 'class'=>'form-control', 'required'=>false, 'tabindex'=>1]) ?>
									</div>
								</div>
							...
							<div class="row gy-4">
								<div class="col-xxl-12 col-md-12">
									<div class="input-container-floating ">
										...
										<?= $this->Form->control('status', [ 'value'=>isset($formpostdata['status'])? $formpostdata['status']: '' , 'label' => false, 'class'=>'form-control', 'id'=>'status1', 'required'=>false, 'tabindex'=>2]) ?>
									</div>
								</div>
							</div>
						</div>
		...
		<div class="card">
			<div class="card-header align-items-center d-flex">
				...
				<!--<div class="submit flt-rght export-btn">
                    ...
                    <?= $this->Html->link(__('Add Vendor'), ['controller' => 'Vendor', 'action' => 'add'], ['class' => 'btn btn-success']) ?>
...
$(document).ready(function () {
	...
	$('#dataTables-example').DataTable({
		...
		"ajax": {
			url : '<?= $this->Url->build(["controller" => "Reviews","action" => "ajaxListIndex"]) ?>',
			data: formdata,
			type: 'POST',
