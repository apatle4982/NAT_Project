...
<div class="row">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xs-12 col-sm-3 col-md-3"> 
                            ...
                            <label for="basiInput" class="form-label">Partner</label>
                                <?php 
                                    echo $this->Form->control('company_id', ['value' => isset($formpostdata['company_id'])? $formpostdata['company_id']: '', 'options' => $companyMsts, 'multiple' => false, 'empty' => 'Select Company', 'class'=>'form-control','label'=>false, 'required'=>true]);
                                ?> 
                            </div>
                        </div>
    ...
    <?php 
        ...
        if(isset($fwViewData['errrowsSHIP']) && !empty($fwViewData['errrowsSHIP'])) {
          echo $this->Lrs->cscTableShow($fwViewData['errrowsSHIP'], 'Below records does not have entry in Ship To County section');    
        }
        
        if(isset($fwViewData['insstracc']) && !empty($fwViewData['insstracc'])) { 
            echo $this->Lrs->cscTableShow($fwViewData['insstracc'], 'Below records inserted in Recording section');    
        }   

        if(isset($fwViewData['updstracc']) && !empty($fwViewData['updstracc'])) { 
            echo $this->Lrs->cscTableShow($fwViewData['updstracc'], 'Below records updated (overwritten) in Recording section');    
        } 
    ?>
    </div>
    </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <table border=1 cellpadding=4 cellspacing=0 style='margin:0 auto'><tr><td><b>For the period</b></td><td><b>Document Name</b></td><td><b>E</b></td><td><b>B</b></td><td><b>P</b></td><td><b>RECORD DATE</b></td><td><b>TIME</b></td></tr><tr><td>2018-02-12</td><td>samplefile.pdf</td><td>E 2018-12345678901 B 123 P 45 </td><td>123</td><td>45</td><td>2018-01-21</td><td>12:20:40</td></tr><tr><td>2018-02-12</td><td>samplefile.pdf</td><td>E 2018-12345678901 B 123 P 45 </td><td>123</td><td>45</td><td>2018-01-21</td><td>12:20:40</td></tr></table> 
            </div>
