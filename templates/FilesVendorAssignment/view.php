	...
	<div class="row">
		<div class="col-xxl-6 col-md-6 col-sm-12">
					...
					<div class="row gy-4">
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								<h4><?= __('Record Status for <u>'.$filesMainData['PartnerFileNumber'].'</u>') ?></h4>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="card-header align-items-center d-flex">
				<label class="card-title"><?= __('Record Details')?></label> 
			</div>
			<div class="card-body">
				<div class="live-preview">
					<div class="row gy-4">
						<div class="col-xxl-12 col-md-12">
							<!--<div class="input-container-floating">	
                                ...
                                <?= __(($FilesVendorAssignment['DocumentReceived']=='Y') ? 'Physical document received': '	Generate Sheet for not received') ?>
							</div>-->
						</div> 
                        ...
                        <div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">	
								...
								$date = (array) $FilesVendorAssignment['date_updated']; ?>
