            ...
            <div class="card-body">
                ...
                <div class="col-xxl-4 col-md-5 col-sm-12">
                    ...
                    <div class="col-xxl-8 col-md-7 col-sm-12">
                        ...
                        <div class="col-xxl-4 col-md-4 col-sm-12">
                        <?= $this->LRS->searchCancelBtnEss('m-r') ?>
                    ...
                    <div class="aolbtns">
                    <!--<input id="assign_ess" Type="submit" value="Assign Escrow Service" class="btn btn-primary" name="assign_ess" />-->
...
echo $this->LRS->showBarCodeModelPopEss($vendorlist, $vendor_services);
...
<script type="text/javascript">
    $(document).ready(function () {
        $(document).on("change", "#vendorid", function () {
			...
			$.ajax({
				url: "<?= $this->Url->build(['controller' => 'FilesVendorAssignment', 'action' => 'getEssService']) ?>",
				type: "POST",
				data: { file_id: fileId },
				dataType: "json",
