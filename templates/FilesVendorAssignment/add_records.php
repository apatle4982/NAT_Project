...
<div class="card" style="margin-top:15px">
	<div class="row">
		<div class="col-xxl-4 col-md-4 col-sm-12">
				...
				<div class="live-preview ">
					<div class="row gy-4">
						<div class="col-xxl-12 col-md-12">
							...
							<label class="form-label mb-0">Partner <span style="color:#CA3F48">*</span></label>
			...
			<!-- Vendor Assignment -->
            <div class="card-header align-items-center d-flex">
				<h4 class="card-title mb-0 flex-grow-1">Vendor Assignment</h4>
			</div>
			<div class="card-body">
				<div class="live-preview ">
					<div class="row gy-4"><b>Available Vendor:</b>
                        <?php echo $this->Form->select('vendorid',$vendorlist,['empty' => 'Select Vendor','class' =>'js-example-basic-single form-control', 'label' => false, 'id' => 'vendorid','style'=>'margin-left:10px;']); ?>
                        </div>
					...
					<div class="row gy-4">
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<?php echo $this->Form->control('TransactionType', 
								['label'=>false,
								'options' => $TransactionTypeList, 'multiple' => false, 'empty' => 'Select Transaction Type','class'=>'form-control', 'required'=>true]); ?>
							</div>		 
						</div>
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
