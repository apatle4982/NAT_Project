			...
			<div class="card-body">
				<div class="live-preview ">
					<div class="row gy-4">
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">	
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['StreetNumber'])) ? $partnerMapFields['mappedtitle']['StreetNumber'] : 'StreetNumber');?></label>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['StreetName'])) ? $partnerMapFields['mappedtitle']['StreetName'] : 'StreetName') ?></label>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<div id="company_div">
								<?php echo $this->Form->control('County', ['label'=>false, 'options' => $CountyList, 'multiple' => false, 'empty' => 'Select County', 'value' => $selectedCounty, 'class'=>'form-control', 'required'=>true]); ?>
								</div>
					...
					<div class="row gy-4">
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['GrantorFirstName1'])) ? $partnerMapFields['mappedtitle']['GrantorFirstName1'] : 'First Name (1)'); ?></label>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['GrantorFirstName2'])) ? $partnerMapFields['mappedtitle']['GrantorFirstName2'] : 'First Name (2)'); ?></label>
					...
					<div class="row gy-4">
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['GranteeFirstName1'])) ? $partnerMapFields['mappedtitle']['GranteeFirstName1'] : 'First Name (1)');?></label>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['GranteeFirstName2'])) ? $partnerMapFields['mappedtitle']['GranteeFirstName2'] : 'First Name (2)');?></label>
					...
					<div class="row gy-4">
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['MortgagorGrantors'])) ? $partnerMapFields['mappedtitle']['MortgagorGrantors'] : 'Grantor(s)')?></label>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['MortgagorGrantorFirstName1'])) ? $partnerMapFields['mappedtitle']['MortgagorGrantorFirstName1'] : 'First Name (1)');?></label>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['MortgagorGrantorFirstName2'])) ? $partnerMapFields['mappedtitle']['MortgagorGrantorFirstName2'] : 'First Name (2)');?></label>
					...
					<div class="row gy-4">
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['MortgageeLenderCompanyName'])) ? $partnerMapFields['mappedtitle']['MortgageeLenderCompanyName'] : 'Lender/Company Name')?></label>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['MortgageeFirstName1'])) ? $partnerMapFields['mappedtitle']['MortgageeFirstName1'] : 'First Name (1)');?></label>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<label class="form-label mb-0"><?= ((isset($partnerMapFields['mappedtitle']['MortgageeFirstName2'])) ? $partnerMapFields['mappedtitle']['MortgageeFirstName2'] : 'First Name (2)');?></label>
					...
					<div class="row gy-4">
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<?php    //pr($FilesVendorAssignment->FileStartDate); ?>
								<div class="input-daterange" id="datepicker">
								<?php echo $this->Form->control('FileStartDate', 
								['label'=>false ,
								'type'=>'text','class'=>'form-control', 'required'=>true, 'value'=>(isset($FilesVendorAssignment['FileStartDate']) ? date('Y-m-d H:i:s', strtotime($FilesVendorAssignment['FileStartDate'])) : '')]); ?>
								</div>
						...
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<?php // echo $this->Form->control('TransactionType', ['label'=>false,'type'=>'text', 'value'=> $FilesVendorAssignment['fva']['TransactionType'], 'class'=>'form-control', 'required'=>false, 'placeholder'=>'Number only (seperated by " , ")']); ?>
								
								<?php echo $this->Form->control('TransactionType', ['type' => 'select','value' => $FilesVendorAssignment['fva']['TransactionType'], 'label' => false, 'options' => $TransactionTypeList, 'multiple' => false, 'empty' => 'Select Transaction Type', 'escape'=>false, 'class'=>'form-control', 'required'=>true ]);?>
								
								<?php echo $this->Form->control('documentTypeHidden', [ 'value'=>($FilesVendorAssignment['TransactionType']==0) ? $FilesVendorAssignment['fva']['TransactionType'] : $FilesVendorAssignment['fva']['TransactionType'] , 'type'=>'hidden']); ?>
							</div>		 
						</div>
						<div class="col-xxl-12 col-md-12">
							<div class="input-container-floating">
								...
								<?php echo $this->Form->control('APNParcelNumber', ['label'=>false, 'class'=>'form-control', 'required'=>false,  'title'=>'Only letters, numbers and special character are allowed (_@./)']); ?>
							</div>														 
						</div>
