			...
			<div class="card-body">
				<div class="live-preview ">
					<div class="row gy-4"><b>Available Vendor:</b>
                        <?php echo $this->Form->select('vendorid',$vendorlist,['empty' => 'Select Vendor','class' =>'js-example-basic-single form-control', 'required'=>'required', 'label' => false, 'id' => 'vendorid']); ?>
                        </div>
