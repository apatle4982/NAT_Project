 ...
 * @var iterable<\App\Model\Entity\ChargeMaster> $chargeMaster
 */
?>
<div class="row">
	<div class="col-lg-12">
			...
			<div class="card-header align-items-center d-flex">
				<h4 class="card-title mb-0 flex-grow-1">
					<div class="submit flt-rght export-btn">
						<?= $this->Html->link(__('Add New Charge'), ['action' => 'add'], ['class' => 'btn btn-primary']) ?>
					</div>
				</h4> 
			</div>
			<div class="card-body">
...
$(document).ready(function () {
	...
	$('#dataTables-example').DataTable({
		...
		"ajax": {
			url : '<?= $this->Url->build(["controller" => "chargeMaster","action" => "ajaxListIndex"]) ?>',
			data: formdata,
			type: 'POST',
