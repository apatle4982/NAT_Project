		...
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				...
				<?php 
					...
					$widgets = ['File', 'Property', 'Mortgagor', 'RecordsAdded', 'ProcessedNot','ShippingStatus', 'shippNrecord', 'Research', 'Accounting', 'QC', 'docReceived'];  
					echo $this->element('searchall_template',['widgets'=>$widgets,'is_generate'=>false]); 
				?>
