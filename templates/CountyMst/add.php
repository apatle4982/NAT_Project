                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6">
                            <div class="input-container-floating">
                                ...
                                <?= $this->form->control('file_avl', ['type' => 'select', 'label'=>false, 'class'=>'form-control', 'options'=>['Yes'=>'Yes', 'No'=>'No']]); ?> 
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="input-container-floating">
                                ...
                                <?=  $this->form->control('cm_file_enabled', ['type' => 'select', 'label'=>false, 'class'=>'form-control', 'options'=>['1'=>'CSC', '2'=>'SF', '3'=>'CSC / SF']]); ?> 
                            </div>
                        </div> 
                        <div class="col-md-6">
                            <div class="input-container-floating">
                                <label for="basiInput" class="form-label">Research</label>
                                <?= $this->form->control('rec_info_avl', ['type' => 'select', 'label'=>false, 'class'=>'form-control', 'options'=>['imagesNoCost'=>'Rec Info & Images No Cost', 'NoimageNocost'=>'Rec Info No Images No Cost', 'fbr'=>'Fee Based Research']]); ?> 
                            </div>
                        </div>
