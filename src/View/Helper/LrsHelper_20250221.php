...
use Cake\View\Helper;
	...
	class LrsHelper extends Helper
	{
		...
		/*public function showBarCodeModelPop(){
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div id="printThisToo">Available Vendor: <select id="vendorDropdown" class="form-control">
			...
			<div class="form-group">
                ...
                <label for="service1">Search Criteria</label>
            </div>
            <div class="form-group">
                <input type="checkbox" class="form-check-input" id="service2"  name="services" value="Service 2">
                <label for="service2">Full Search</label>
            </div>
            <div class="form-group">
                <input type="checkbox" class="form-check-input" id="service3"  name="services" value="Service 3">
                <label for="service3">24 Month</label>
            </div>
            <div class="form-group">
                <input type="checkbox" class="form-check-input" id="service4"  name="services" value="Service 4">
                <label for="service4">Current Owner</label>
            </div>
			<div class="form-group">
                <input type="checkbox" class="form-check-input" id="service4" name="services" value="Service 4">
                <label for="service4">Tax and Legal</label>
            </div>

						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default" data-bs-dismiss="modal">Submit</button>
