...
class CustomPaginationComponent extends Component
{
	...
	public function getActionButtons($modelName,$value,array $key,$prifix=null,$hideViewBtn = 0){
		...
		{ 
			...
			//$text .= '<a href="'.Router::url(['controller' => $modelName,'action' => 'aoledit'.$prifix.'/'.$value[$key[0]]]).'" title="Edit" class="link-success fs-15"><i class="ri-edit-2-line" aria-hidden="true"></i></a> ';
                ...
                if($aoldata['pre_aol_status']=='Y'){
                    $text .= '<a href="'.Router::url(['controller' => 'pdf','action' => 'generatePdf/'.$data['RecId']]).'" title="Download Preliminary AOL PDF" class="link-success fs-15"><i class="ri-file-pdf-line" aria-hidden="true"></i></a> ';
    				$text .= '<a href="'.Router::url(['controller' => 'pdf','action' => 'emailPdf/'.$data['RecId']]).'" title="Preliminary AOL Email" class="link-success fs-15 email_pop_btn" data-bs-toggle="modal" data-bs-target="#emailModal"><i class="ri-mail-line" aria-hidden="true" data-bs-id="'.$data['RecId'].'"></i> </a>';
                }
                if($aoldata['final_aol_status']=='Y'){
                    $text .= '<a href="'.Router::url(['controller' => 'pdf','action' => 'generatePdf/'.$data['RecId'].'/finalpdf']).'" title="Download Final AOL PDF" class="link-success fs-15"><i class="ri-file-pdf-fill" aria-hidden="true"></i></a> ';
                    $text .= '<a href="'.Router::url(['controller' => 'pdf','action' => 'emailPdf/'.$data['RecId']]).'" title="Final AOL Email" class="link-success fs-15 email_pop_btn_final" data-bs-toggle="modal" data-bs-target="#emailModal"><i class="ri-mail-fill" aria-hidden="true" data-bs-id="'.$data['RecId'].'"></i> </a>';
                }
                if($aoldata['submit_aol_status']=='Y'){
                    $text .= '<a download href="'.$fileUrl.'" title="Download Signed AOL PDF" class="link-success fs-15"><i class="ri-file-pdf-line" aria-hidden="true"></i></a> ';
                    $text .= '<a href="'.Router::url(['controller' => 'pdf','action' => 'emailPdf/'.$data['RecId']]).'" title="Submit Approved AOL to Client" class="link-success fs-15 email_pop_btn_submit" data-bs-toggle="modal" data-bs-target="#emailModal"><i class="ri-send-plane-line" data-bs-id="'.$data['RecId'].'"></i> </a>';
                }
}
				$text .= '<a href="javascript:void(null);" title="Delete" onclick="openPasswordModel('.$value[$key[2]].')" class="link-danger fs-15"><i class="ri-delete-bin-line" aria-hidden="true"></i></a> ';
			return $text;
