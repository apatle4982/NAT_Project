...
class NatApiController extends AppController
{
    ...
    public function getPreAol($PartnerFileNumber=null)
    {
        ...
        if($aloAssignmentData->pre_aol_status == 'Y'){
            ...
            //""https://nat.tiuconsulting.us/home/nattiuconsulting/public_html/webroot/files/export/aol_assignment/pdf/pre/AssignmentDetails-5.pdf",";

            $pdfPath = str_replace("home/nattiuconsulting/public_html/webroot/","",$pdfPath);
            $pdfPath = "https://nat.tiuconsulting.us".$pdfPath;
            $this->set([
                'status' => "success",
                'document_type' => "preliminary",
