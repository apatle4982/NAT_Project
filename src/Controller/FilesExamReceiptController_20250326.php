    ...
    */
    ...
    public function upload(){
        ...
        if ($this->request->is('post')) {
            ...
            $expectedFields = [
                "NATFileNumber", "OfficialPropertyAddress", "VestingDeedType", "VestingConsiderationAmount",
            ...
            while (($row = fgetcsv($csvFile)) !== false) {
                ...
                $RecId = $this->FilesMainData->find()->select('Id')->where(['NATFileNumber' => $data['NATFileNumber']])->first();
                if (!$RecId) {
                    $errorCount++;
                    continue;
                }
