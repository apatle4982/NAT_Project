    ...
    */
    ...
    public function upload() {
        ...
        if($this->request->getData('companyid')){
            ...
            //echo "mst_fields<pre>";print_r($mst_fields);echo "</pre>";
        ...
        if ($this->request->is('post')) {
            ...
            if ($mediaType === 'text/csv') {
                ...
                if (array_diff($header, $allowed_fields_filtered) || array_diff($allowed_fields_filtered, $header)) {
                    fclose($csvFile);
                    unlink($filePath);
