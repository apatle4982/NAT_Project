 ...
 */
class CompanyFieldsMapTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config): void
    {
        ...
        $this->setTable('company_fields_map');
 ...
 */
    ...
    public function checkMapFieldsTitleById($company_id = null,  array $mapTitlesId){
		...
		if(!empty($company_id)){
			// search by company Id 
			$query = $this->find()
						->where(['CompanyFieldsMap.cfm_companyid'=>$company_id, 'fm.fm_id IN'=>$mapTitlesId])
						->join([
							'table' => 'fields_mst',
							'alias' => 'fm',
							'type' => 'LEFT',
							'conditions' => 'CompanyFieldsMap.cfm_fieldid = fm.fm_id'
						])->select(['fm.fm_id','fm.fm_title','fm.field_sections_id', 'CompanyFieldsMap.cfm_maptitle']);
